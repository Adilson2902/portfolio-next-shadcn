    ...
    <section id="home" className="relative pt-16 sm:pt-24 pb-12 text-center overflow-hidden">
      ...
      "
        ...
        >
          ...
          <a
            href="https://wa.me/5581982644557"
            target="_blank"
            rel="noopener noreferrer"
            className="glass-effect px-6 py-3 rounded-xl flex items-center gap-3 modern-hover border border-emerald-500/30 hover:border-emerald-500/60 transition-all group"
          >
