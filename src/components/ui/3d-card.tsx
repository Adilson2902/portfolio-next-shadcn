...
export const CardContainer = ({
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    containerRef.current.style.transform = `rotateY(${x}deg) rotateX(${y}deg) scale(1.04)`;
  };
    ...
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      ...
      >
        <div
          ...
          className={cn(
            "flex items-center justify-center relative transition-transform duration-150 ease-out will-change-transform",
            className
          )}
          style={{
